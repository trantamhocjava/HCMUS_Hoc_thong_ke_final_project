...
export default function App() {
  ...
  let btnColor = "";
  if (!loading) {
    btnColor = "bg-[#54a399] hover:bg-[#3c8379] hover:border-[#3c8379]";
  }
  else {
  ...
  return (
    ...
    <div className=" h-screen py-10 bg-gradient-to-r from-[#186a5e] to-[#053339] text-[#e1eeeb] min-w-[700px]" >
      ...
      <div className="bg-gradient-to-r from-[#0b201d] to-[#021619] rounded-3xl shadow-2xl flex-col w-[70%] mx-auto p-12 gap-4">
        <header className="text-center mb-10">
          <h1 className="font-handjet text-8xl uppercase font-bold">Machine Translation</h1>
        ...
        <main className="flex flex-col gap-4 justify-center">
          <form className="flex justify-center align-middle  flex-col md:flex-row gap-4 w-[100%]" onSubmit={handleSubmit}>
            ...
            <button
              className={`font-handjet text-xl text-white justify-center align-middle py-auto my-auto rounded h-[50px] w-[100px] mx-auto ${btnColor}`} type="submit" disabled={loading}
